  <!--   <div class="h-100 dk-div-border p-1"> -->
        <div class="dk-f-l h-100 col-4 p-0 dk-overflow-auto">
        	<div class=" h-50 m-0 p-0 form-control">
				...
				<p class="text-center d-none dk-input-field"></p>
				<img id="objImage" src=" {{--$bsobjects[0]->image_src--}} " alt="Изображение" class="w-100 h-100 dk-text-info ">
			</div> 	
        ...
        <div class="p-0 dk-f-l h-100 col-8 dk-text-color">
            <div class="dk-h-10p">
				<h2 class="text-center font-weight-bold">Пользователь 
